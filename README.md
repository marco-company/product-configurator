...
--- | --- | --- | ---
[product_configurator](product_configurator/) | 16.0.1.1.2 | [![PCatinean](https://github.com/PCatinean.png?size=30px)](https://github.com/PCatinean) | Base for product configuration interface modules
